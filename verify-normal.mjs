...
async function verifyRemotionNormal() {
    console.log('Using a standard Lottie file for verification');
    
    // Create a simple Lottie JSON
    const layers = [];
    for (let i = 0; i < 100; i++) {
        layers.push({
            ddd: 0,
    ...
    formData.append('file', blob, 'normal-test.json.zlib');
